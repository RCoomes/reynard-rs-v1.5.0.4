...
class rsUserhelper
{
	...
	public function replaceBillingCommonFields($template_desc, $post = array(), $lists)
	{
		...
		$template_desc = str_replace("{company_name}", '<div><input class="inputbox" type="text" name="company_name" id="company_name" size="32" maxlength="250" value="' . @$post ["company_name"] . '" /></div>', $template_desc);
	...
	public function replaceCompanyCustomer($template_desc, $post = array(), $lists)
	{
		...
		$template_desc = str_replace("{company_name}", '<input class="inputbox" type="text" name="company_name" id="company_name" size="32" maxlength="250" value="' . @$post ["company_name"] . '" />', $template_desc);
