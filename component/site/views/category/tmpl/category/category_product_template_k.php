						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="odd"><td class="attributes-left">Coating</td><td class="attributes-right">{producttag:rs_coating}</td></tr>
									<tr class="even"><td class="attributes-left">Wavelength</td><td class="attributes-right">{producttag:rs_wavelength}</td></tr>
