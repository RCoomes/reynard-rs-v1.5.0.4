						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Retardance</td><td class="attributes-right">{producttag:rs_retardance}</td></tr>
									...
									<tr class="odd"><td class="attributes-left">Birefringence</td><td class="attributes-right">{producttag:rs_birefringence}</td></tr>
