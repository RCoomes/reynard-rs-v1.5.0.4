						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Reflection</td><td class="attributes-right">{producttag:rs_reflection}</td></tr>
									<tr class="odd"><td class="attributes-left">Split Ratio (%)</td><td class="attributes-right">{producttag:rs_split_ratio}</td></tr>
