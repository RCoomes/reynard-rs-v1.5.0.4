						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="odd"><td class="attributes-left">Optical Density (OD)</td><td class="attributes-right">{producttag:rs_optical_density}</td></tr>
							...
							<div class="detail-right">
								...
								<?php } ?>
								<div class="product_question_link" style="text-align: center;"><a class="redcolorproductimg" href="/component/redshop/?view=ask_question&tmpl=component">Ask Question About Product</a></div>
