						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Blocking</td><td class="attributes-right">{producttag:rs_blocking}</td></tr>
									<tr class="odd"><td class="attributes-left">Laser Damage</td><td class="attributes-right">{producttag:rs_laser_damage}</td></tr>
									...
									<tr class="odd"><td class="attributes-left">Cut On</td><td class="attributes-right">{producttag:rs_cut_on}</td></tr>
									<tr class="even"><td class="attributes-left">Cut Off</td><td class="attributes-right">{producttag:rs_cut_off}</td></tr>
									<tr class="odd"><td class="attributes-left">Slope</td><td class="attributes-right">{producttag:rs_slope}</td></tr>
									<tr class="even"><td class="attributes-left">Transmission</td><td class="attributes-right">{producttag:rs_transmission}</td></tr>
								</table>
							</div>
