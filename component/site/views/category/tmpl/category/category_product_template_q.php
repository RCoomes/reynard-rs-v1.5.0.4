                        ...
                        <div id="slidingDiv_{product_id}" class="product-details">
                            <div class="detail-left">
                                <table width="100%" border="0">
                                    ...
                                    <tr class="even"><td class="attributes-left">Surface Flatness</td><td class="attributes-right">{producttag:rs_surface_flatness}</td></tr>
                                    <tr class="odd"><td class="attributes-left">Transmitted Wavefront Error (TWE)</td><td class="attributes-right">{producttag:rs_transmitted_wavefront_error}</td></tr>
