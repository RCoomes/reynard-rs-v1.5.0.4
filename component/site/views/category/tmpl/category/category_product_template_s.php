						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Beam Deviation</td><td class="attributes-right">{producttag:rs_beam_deviation}</td></tr>
									...
									<tr class="odd"><td class="attributes-left">Wedge</td><td class="attributes-right">{producttag:rs_wedge}</td></tr>
								</table>
							</div>
