						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
                                    <tr class="odd"><td class="attributes-left">Beam Deviation</td><td class="attributes-right">{producttag:rs_beam_deviation}</td></tr>
                                    ...
                                    <tr class="even"><td class="attributes-left">Centration</td><td class="attributes-right">{producttag:rs_centration}</td></tr>
                                    ...
                                    <tr class="odd"><td class="attributes-left">Material</td><td class="attributes-right">{producttag:rs_material}</td></tr>
							...
							<div class="detail-right">
								...
								<?php } ?>
								<div class="product_question_link" style="text-align: center;"><a class="redcolorproductimg" href="/component/redshop/?view=ask_question&tmpl=component&pid={product_id}&type=raw&Itemid={product_id}">Ask Question About Product</a></div>
