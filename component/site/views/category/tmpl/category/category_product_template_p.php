						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Index of Refraction (IOR)</td><td class="attributes-right">{producttag:rs_ior}</td></tr>
									...
									<tr class="odd"><td class="attributes-left">Operating Temperature</td><td class="attributes-right">{producttag:rs_temperature}</td></tr>
								</table>
							</div>
