						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Center Wavelength</td><td class="attributes-right">{producttag:rs_center_wavelength}</td></tr>
									...
									<tr class="even"><td class="attributes-left">Parallelism</td><td class="attributes-right">{producttag:rs_parallelism}</td></tr>
								</table>
							</div>
