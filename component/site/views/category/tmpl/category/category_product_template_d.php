						...
						<div id="slidingDiv_{product_id}" class="product-details">
							<div class="detail-left">
								<table width="100%" border="0">
									...
									<tr class="even"><td class="attributes-left">Dimensions</td><td class="attributes-right">{producttag:rs_dimensions}</td></tr>
									<tr class="odd"><td class="attributes-left">Thickness</td><td class="attributes-right">{producttag:rs_thickness}</td></tr>
									<tr class="even"><td class="attributes-left">Bevel</td><td class="attributes-right">{producttag:rs_bevel}</td></tr>
									<tr class="odd"><td class="attributes-left">Edge Finish</td><td class="attributes-right">{producttag:rs_edge_finish}</td></tr>
									<tr class="even"><td class="attributes-left">Surface Quality (SQ)</td><td class="attributes-right">{producttag:rs_surface_quality}</td></tr>
									<tr class="odd"><td class="attributes-left">Clear Aperture (CA)</td><td class="attributes-right">{producttag:rs_clear_aperture}</td></tr>
									<tr class="even"><td class="attributes-left">Angle Of Incidence (AOI)</td><td class="attributes-right">{producttag:rs_aoi}</td></tr>
									<tr class="odd"><td class="attributes-left">Surface Flatness</td><td class="attributes-right">{producttag:rs_surface_flatness}</td></tr>
									<tr class="even"><td class="attributes-left">Transmitted Wavefront Error (TWE)</td><td class="attributes-right">{producttag:rs_transmitted_wavefront_error}</td></tr>
									<tr class="odd"><td class="attributes-left">Parallelism</td><td class="attributes-right">{producttag:rs_parallelism}</td></tr>
									...
									<tr class="even"><td class="attributes-left">Bandwidth</td><td class="attributes-right">{producttag:rs_bandwidth}</td></tr>
	   								<tr class="odd"><td class="attributes-left">Blocking</td><td class="attributes-right">{producttag:rs_blocking}</td></tr>
									<tr class="even"><td class="attributes-left">Operating Temperature</td><td class="attributes-right">{producttag:rs_temperature}</td></tr>
	   								<tr class="odd"><td class="attributes-left">Center Wavelength</td><td class="attributes-right">{producttag:rs_center_wavelength}</td></tr>
	   								<tr class="even"><td class="attributes-left">Cut On</td><td class="attributes-right">{producttag:rs_cut_on}</td></tr>
									<tr class="odd"><td class="attributes-left">Cut Off</td><td class="attributes-right">{producttag:rs_cut_off}</td></tr>
									<tr class="even"><td class="attributes-left">Laser Damage</td><td class="attributes-right">{producttag:rs_laser_damage}</td></tr>
									<tr class="odd"><td class="attributes-left">Transmission</td><td class="attributes-right">{producttag:rs_transmission}</td></tr>
								</table>
							</div>
