...
<div class="product-details" style="display: block; padding-left: 0; width: 100%;">
    <div class="detail-left">
        <table style="width: 100%;" border="0">
            <tbody>
            <tr class="odd">
                <td class="attributes-left">Substrate Material</td>
                <td class="attributes-right">{rs_substrate_material}</td>
            </tr>
            <tr class="even">
            ...
            <tr class="odd">
                <td class="attributes-left">Optical Density (OD)</td>
                <td class="attributes-right">{rs_optical_density}</td>
            </tr>
            <tr class="even">
